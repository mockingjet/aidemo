...
$result['data'] = $randdata[rand(0,1)];
$randimg = array("./out3.jpg", "./0bp_result.jpg");
$result['image_file'] = $randimg[rand(0,1)];
$result['thumb_file'] = "./0_result.jpg";
$rand = array(array(
  0=> 5,
  1=> 60.7,
  2=> 17.3,
...
$result['color'] = json_decode($temp[rand(0,1)],true);
